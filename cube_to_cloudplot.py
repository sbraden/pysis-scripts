...
def clem_or_wac(img_name):
    ...
    image_scaled = image.apply_scaling()
    image_nan = image_scaled.apply_numpy_specials()
    if img_name[-7:-4] == 'wac':
        wac_320 = image_nan[0].T
        wac_415 = image_nan[2].T
        ...
        clm_950 = image_nan[3].T
        clm_750 = image_nan[1].T
